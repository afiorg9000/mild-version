...
export const responses: Response[] = [
  ...
  {
    name: "April",
    impact: "I'm so grateful of your wonderful kindness and connectedness that you bring not only to my love but to all the people you share your friendship with",
  ...
  {
    name: "Alex",
    impact: "My boring answer is that he helped me find friends and a community here in the Bay (Ryan was quite literally my first friend here). The heartfelt answer is he’s consistently shown up as someone who really cares about me and wants to spend quality time with me no matter what, which was so important when I had just moved here.",
    unforgettableMemory: "Noooooo I don’t get only one. No. The funny one is our basketball showdown with the other Australians. The cunts! The memory-feeling-mash I want is galavanting around Room Service together.",
    whatToHear: "Your steadfast presence as a friend means a lot to me. Thank you.",
    loveAdmire: "Showing up endlessly with authenticity and honesty. That Ryan smile.",
    growthArea: "I want Ryan to achieve the degree and type of self-actualization he desires.",
    yearVision: "I want Ryan to achieve the degree and type of self-actualization he desires.",
    reflections: ""
  },
  {
    name: "Aunt Paula",
    impact: "Ryan you are loving and caring, and very inspirational! Many many years ago, when maybe we didn't click right, you looked me in the eyes and asked me to explain my reaction/actions. I remember those eyes. I needed to communicate better. You taught me to listen, explain, listen, and teach. I don't know if you remember that moment, but I do. Thank you! I hope I'm a better listener.",
    unforgettableMemory: "I'll never forget the conversation we had about how successful you would be. That someday I would see you as a professor or your work would be published. Bravo! 👏",
    whatToHear: "I love you Ryan! You make me very proud to be your Aunt!  I see YOU making a difference! Thank you for letting me ride along in the background!",
    loveAdmire: "I love your continued growth!  You work endlessly to always make yourself a better person. You love, and love hard when you do. Determination and perseverance, you definitely have!",
    growthArea: "Be in the moment, fully. Whether it's coffee with a friend, a walk with someone you love, or that long distance call to catch up, STAY FOCUSED on that connection, at that time. Work will be there when you are done.",
    yearVision: "Possibilities are endless with you! I'm not sure of your work goals, but leave room for love and family. Love your Mum, we're not getting any younger!",
    reflections: ""
  },
  {
    name: "Brian",
    impact: "He's made me feel appreciated and seen.",
    unforgettableMemory: "A moment together, eye contact at 2 am at a cheap diner. Mutual respect, understanding, connection and the ineffable.",
    whatToHear: "Someone who can work for the food of all while embodying the care and warmth on a personal level as well. a rare creature of God.",
    loveAdmire: "",
    growthArea: "",
    yearVision: "Fulfilling love, progress at his work, and friendship.",
    reflections: ""
  },
  {
    name: "Ece",
    impact: "Ryan was one of the first people I met in the Bay and has been so insanely welcoming every single interaction since then. He's played a significant role in me feeling part of a community here and I've always felt I can go talk to him, and that I'm welcomed by him.",
    unforgettableMemory: "Hard to pick one! I don't think this one is more significant than others but I'll pick the time he was talking about how applying pressure on someone feels good when they might be autistic. I think about that from time to time:)",
    whatToHear: "Ryan to me is a really authentic and honest person. He's surprised me by how he is genuinely himself in the various contexts I've seen him. He shows up, is self-aware, and that authentic version of him happens to be such a pleasant and well-meaning person.",
    loveAdmire: "He has such an approachable quality about him!",
    growthArea: "An even deepening relationship with Sofia:) Happy existence, Ryan!",
    yearVision: "",
    reflections: ""
  },
  {
    name: "Erin",
    impact: "It's hard to put into words! Has been beyond cool to reconnect and find so much in common after many years out of touch.",
    unforgettableMemory: "Hmm, there are probably better answers, but it will never not be entertaining to me when people say, 'You two are cousins??'",
    whatToHear: "I don't think I wouldn't say this, but I'm grateful to have him as family! I regret that I'm not able to visit more often, but I hope that I can do better with finding and making the time between life and work to show up.",
    loveAdmire: "He's out there doing the work that most people don't even realize we need.",
    growthArea: "Stay baller!!",
    yearVision: "Always hoping for balance, health, happiness, and much, much more.",
    reflections: ""
  },
  {
    name: "Gavan",
    impact: "Being a grounding force in a crazy field.",
    unforgettableMemory: "",
    whatToHear: "",
    loveAdmire: "",
    growthArea: "",
  ...
  {
    name: "Harlan",
    impact: "By making our house a more fun and joyful place!",
    unforgettableMemory: "We went to a dance club to dance to EDM. This was during a time when I had been spending way too much time being reclusive and sedentary and only thinking about scary bad AI stuff, and it was really good for my soul to go and dance. I'm thankful to Ryan for spontaneously inviting me, and also he's fun to dance with!",
    whatToHear: "My primary interest/career (AI safety) has put me in a social bubble with a lot of very serious and mission-focused people. I appreciate being around the seriousness and mission-focusedness, but I also want to party and vibe sometimes. I appreciate Ryan because he's one of the people who can be serious/mission-focused AND knows how to party and vibe.",
    loveAdmire: "I admire his dedication to fitness. He seems to have a very healthy attitude towards it, purely positive and not masochistic or anything like that. Very inspiring.",
    growthArea: "",
    yearVision: "",
    reflections: ""
  },
  {
    name: "Iski",
    impact: "Plainly the gusto and enthusiasm with which you greet me makes me feel so seen and supported, it means I feel that effect every time I see you.",
    unforgettableMemory: "Gosh I wish we'd had more shared experiences but I sure love dancing with you.",
    whatToHear: "You really do inspire me to raise the amount of love and care and curiosity and schtick I put out. Thank you for that.",
    loveAdmire: "I appreciate the fearless expression with which you bring people together and the sheer amount of information that gets exchanged and made available.",
    growthArea: "",
    yearVision: "",
    reflections: ""
  },
  {
    name: "Keri",
    impact: "Ryan’s a really inspiring guy. A proof by construction that you can be dedicated to a mission AND play hard, and love abundantly and also be a chill cool dude.",
    unforgettableMemory: "Circling at bushy! I was blown away by the sheer degree of fascination that you brought with you.",
    whatToHear: "I really liked the post about the bar area tropes and doing enough. I think the world will be improved by your continued externalized thinking.",
    loveAdmire: "I think you have a bit of a regulating/‘it will be ok’ aura. extremely valuable.",
    growthArea: "[low confidence] i think it’d be cool to see a bit more of circling-Ryan outside of circling. I think it could temper the imposingness that’s inherent in being a large confident man.",
    yearVision: "perhaps you will find an opportunity to do even grander things (and uplevel others) by handing off things you’ve built.",
    reflections: "this is adorable <3"
  },
  {
    name: "Luke",
    impact: "Ryan has offered me advice on girl drama, laughed at dumb shit with me, and danced his heart out with me! I also really appreciate his commitment to improve, whether that's how MATS operates, his lifts, or anything else he notices could be better. Ryan is existence proof for me that hard work pays off.",
    unforgettableMemory: "Oliver Koletzki (part two, because part one was amazing but difficult to remember)",
    whatToHear: "You feel like a brother to me. We are close emotionally with a shitton of trust, but we love to spend most of our time together just doing stupid shit like watching funny shows, which I love.",
    loveAdmire: "biceps",
    growthArea: "",
    yearVision: "",
    reflections: ""
  ...
  {
    name: "Nate",
    impact: "Ryan along with the others welcomed me into the friend group after Gem and I had been seeing each other for a while. His bad movie nights brought some of the heartiest laughter I'd had in a while and I always felt very welcome and seen at all the various events and gatherings.",
    unforgettableMemory: "The pool party at his parent's house followed by us all dressing up in various costumes for some reason 😂",
    whatToHear: "You're doing great work and may very well be one of the enlightened who will help guide us into a post-AI-singularity future.",
    loveAdmire: "His kindness in accepting all folk.",
    growthArea: "If he could grow a third arm, he could type code faster maybe?",
    yearVision: "Great things!",
    reflections: ""
  },
  {
    name: "Nick",
    impact: "Nick, I am truly always in awe of your passion, creativity and love for life. As a byproduct this translates into epic parties with friends that push the limits of what could be. Seriously you host cool-creative-kikis and it’s a blast to co-create with you whenever I can ✨ I think our friendship is deeply rooted in weird, chaotic, fun, that brings the community together. Honestly. It meant a lot to me the one time we had our brief catch up and you queued me into what’s going on in your world. There was a killer party downstairs - per usual - and you needed to let something off your chest. It meant a lot to me that you confided and trusted me. I liked the feeling of supporting you. Like it’s one thing to be fun friends, but I really appreciate when friendships can go deeper.",
    unforgettableMemory: "Nick helped me think through what I wanted from career stuff, as we walked the evening streets of the Mission on Danceoween. Thanks Nick, you're a true nick.",
    whatToHear: "Your dedication to yourself. Your big brain, your muscles, your loved ones, and most importantly your HEART 💖",
    loveAdmire: "Mmmmmm. I actually think you are very self improvement oriented and self aware…. Sometimes to your own detriment. I would tell you to be less hard on yourself and learn to follow your intuition more.",
    growthArea: "I’d like to believe that your last name steams from the concept of the baby goat, a kid. Yes, you are indeed the Greatest Of All Time!! Duh!! But don’t forget to take it easy sometimes and lean into your child like wonder that is your curiosity and creativity.",
    yearVision: "Happy Barfday Ryan. Sofia is such a sweetie for putting this together and it shows how much she loves you. I’m really happy for the two of you 💖 And I’m so lucky to be both of your friend ✨",
    reflections: ""
  },
  {
    name: "Paola",
  ...
  {
    name: "Rosie",
    impact: "Ryan reached out to me when he was worried that a mutual friend was being mistreated, and wanted advice on how to handle it. I was touched both by how much concern he had towards her, and that he valued my opinion on it. I've noticed that Ryan seems to be strongly driven by kindness and doing the right thing, in social situations as well as his work, and I find this very inspiring.",
    unforgettableMemory: "",
    whatToHear: "",
    loveAdmire: "",
    growthArea: "",
  ...
  {
    name: "Thor",
    impact: "At Nick's Nick party, I was able to connect w Nick, my bud and housemate. Nick brings joy and whimsy to the party. Nick brings perspective and emotional depth to the friendship. I especially appreciate when Nick helped me think through what I wanted from career stuff, as we walked the evening streets of the Mission on Danceoween.",
    unforgettableMemory: "Thanks Nick, you're a true nick.",
    whatToHear: "",
    loveAdmire: "",
    growthArea: "",
    yearVision: "",
  ...
  {
    name: "Xóchitl",
    impact: "Your facial expressions, and how you light up with excitement and passion are contagious and a gift to be able to witness. Thank you for sharing a bit of your world with me each time we see each other and resume where we left off in a way that makes me feel like a close friend. Even if we don’t see each other for a while, it feels like I just found a bestie whenever I spot you at parties, and feel a sigh of relief to be able to catch up with you. Every time I share something vulnerable with you (fears/anxious thoughts, disagreements, feedback, sweet vibes), I am met with present and empathetic eye contact, curiosity, patience and empathy(or clear boundaries when you are at capacity and can’t hold space). Thanks for making a homie feel understood.",
    unforgettableMemory: "",
    whatToHear: "",
    loveAdmire: "",
    growthArea: "Work life balance, Relationship milestones and sustainability with my home girl Sofia(ty for setting this up btw!), Cozy movie nights, Themed parties, Going out to dance with the homies(lets go to a Brazilian funk party!), Room service maybe?, And lots of success with MATS",
    yearVision: "",
    reflections: ""
  },
  {
    ...
    yearVision: "Hitting a point at MATS where he can delegate enough and systems run themselves so that he can relax a bit!",
    reflections: ""
  }
];
